...
public class Juego {
    ...
    public Principal.comprobacion jugada(int idJugador,int numJugado){
        if(numJugado==numOculto){
            ganador=idJugador;
            return Principal.comprobacion.ACIERTO;
        }else if(numJugado>numOculto){
            turno=actualizaTurno(turno);
            return Principal.comprobacion.MENOR;
        }else{
            turno=actualizaTurno(turno);
            return Principal.comprobacion.MAYOR;
        }
    }
