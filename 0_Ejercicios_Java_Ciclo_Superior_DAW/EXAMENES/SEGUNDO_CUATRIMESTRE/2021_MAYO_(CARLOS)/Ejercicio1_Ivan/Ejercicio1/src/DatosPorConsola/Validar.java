...
public class Validar {
     ...
     *
     */
    public static boolean validarStringLY(String dato) {
        if (dato.equals("")) {
            System.out.println("El dato no puede ser vacio. Vuelva a introducir de nuevo.");
            return false;
        }
        if (!dato.equals("L") && !dato.equals("Y")) {
            System.out.println("Solo pueden ser valores L o Y. Vuelva a introducir de nuevo.");
            return false;
        }
        return true;
    }
     ...
     *
     */
    public static boolean validarStringCBPV(String dato) {
        if (dato.equals("")) {
            System.out.println("El dato no puede ser vacio. Vuelva a introducir de nuevo.");
            return false;
        }
        if (!dato.equals("C") && !dato.equals("B") && !dato.equals("P") && !dato.equals("V")) {
            System.out.println("Solo pueden ser valores C,B,P o V. Vuelva a introducir de nuevo.");
            return false;
        }
        return true;
    }
